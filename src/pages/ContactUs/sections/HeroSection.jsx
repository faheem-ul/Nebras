...
const HeroSection = () => {
    ...
    return (
        <div className="relative w-full min-h-[827px] bg-[#393C3D] overflow-hidden ">
            ...
            {/* Main Content */}
            <div className="relative flex flex-col  min-h-[827px] max-w-[1312px] mx-auto pt-[377px] px-5" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
                ...
                <div data-aos="fade-up" data-aos-delay="400">
                    <Text className="max-w-[648px] text-[16px] md:text-[18px] md:leading-[32px] text-white mt-[61px]">
                        {isArabic
